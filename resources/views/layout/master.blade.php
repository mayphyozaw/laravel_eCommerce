...
<head>
    <meta charset="utf-8">
    <title>MAY - Jewelry eCommerce</title>
    <meta name="description" content="Morden Bootstrap HTML5 Template">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('web_assets/assets/img/favicon.ico') }}">

    <link rel="stylesheet" href="{{ asset('web_assets/assets/css/plugins/swiper-bundle.min.css') }}">
    <link rel="stylesheet" href="{{ asset('web_assets/assets/css/plugins/glightbox.min.css') }}">
    <link
        href="../../../../fonts.googleapis.com/css27fb3.css?family=Frank+Ruhl+Libre:wght@300;400;500;700;900&amp;family=Karma:wght@300;400;500;600;700&amp;display=swap"
        rel="stylesheet">

    <link rel="stylesheet" href="{{ asset('web_assets/assets/css/vendor/bootstrap.min.css') }}">
...
<body>
    ...
    <!-- Quickview Wrapper -->
    <div class="modal fade" id="examplemodal" tabindex="-1" aria-hidden="true" hidden>
                    ...
                    <div class="row row-cols-lg-2 row-cols-md-2">
                        ...
                        <div class="col">
                            <div class="quickview__info">
                                <form action="#">
                                    <h2 class="product__details--info__title mb-15">Z 7-8mm Freshwater Button is
                                    </h2>
                                    ...
                                    <p class="product__details--info__desc mb-15">Lorem ipsum dolor sit amet,
                                        consectetur adipisicing elit is. Deserunt totam dolores ea numquam labore!.
                                    </p>
                                    <div class="product__variant">
                                        ...
                                        <div class="quickview__variant--list quantity d-flex align-items-center mb-15">
                                            ...
                                            <button class="primary__btn quickview__cart--btn" type="submit">Add
                                                To
                                                Cart</button>
                                        </div>
    ...
    <script src="{{ asset('web_assets/assets/js/vendor/popper.js') }}" defer="defer"></script>
    <script src="{{ asset('web_assets/assets/js/vendor/bootstrap.min.js') }}" defer="defer"></script>
    <script src="{{ asset('web_assets/assets/js/plugins/swiper-bundle.min.js') }}"></script>
    <script src="{{ asset('web_assets/assets/js/plugins/glightbox.min.js') }}"></script>

    <script src="{{ asset('web_assets/assets/js/script.js') }}"></script>
    {{-- toastify js --}}

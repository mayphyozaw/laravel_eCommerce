                ...
                <div class="home__three--slider__items">
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-7 offset-lg-2">
                                <div class="slider__content text-center">
                                    <h2 class="slider__maintitle text__primary h1">Jewelry to fit every budget,
                                        occasion, and taste</h2><br>
                                    <a class="primary__btn slider__btn" href="{{ route('userPostLogin') }}">
                                        Login

                                    </a>
                                    <a class="primary__btn slider__btn" href="{{ route('register') }}">
                                        Register
                    ...
                    <div class="hero__slider--layer style3">
                        <img class="slider__layer--img"
                            src="{{ asset('web_assets/assets/img/slider/home3-slider1-layer.webp') }}" alt="slider-img">
                    </div>
                </div>
            </div>
            <div class="swiper-slide">
                <div class="home__three--slider__items">
                    ...
                    <div class="hero__slider--layer style3">
                        <img class="slider__layer--img"
                            src="{{ asset('web_assets/assets/img/slider/home3-slider2-layer.webp') }}" alt="slider-img">
                    </div>
                </div>
            </div>
            <div class="swiper-slide">
                <div class="home__three--slider__items">
                    ...
                    <div class="hero__slider--layer style3">
                        <img class="slider__layer--img"
                            src="{{ asset('web_assets/assets/img/slider/home3-slider3-layer.webp') }}" alt="slider-img">
                    </div>
                </div>
            </div>
        </div>

                            ...
                            <div class="footer__logo">
                                <a class="footer__logo--link" href="">
                                    <img class="footer__logo--img"
                                        src="{{ asset('web_assets/assets/img/logo/mp_logo.png') }}" alt="logo-img">
                                </a>
                            </div>
    ...
    <div class="footer__bottom">
        <div class="container">
            <div class="footer__bottom--inenr d-flex justify-content-between align-items-center">
                <p class="copyright__content mb-0"><span class="text__secondary" style="font-size: 14px">©
                        2025</span> Powered by <a class="copyright__content--link" target="_blank"
                        href="https://themeforest.net/search/hooktheme" style="font-size: 14px"> MP</a> . All Rights
                    Reserved.
                </p>
                <div class="footer__payment">
                    <img src="{{ asset('web_assets/assets/img/icon/payment-img.webp') }}" alt="payment-img">
                </div>
            </div>
        </div>
    </div>

...
@section('banner-text', 'All Products')
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-3 col-lg-4 shop-col-width-lg-4">
                        ...
                        <ul class="widget__tagcloud">
                            @foreach ($brand as $b)
                                <li class="widget__tagcloud--list">
                                    <a class="widget__tagcloud--link" href="{{ url('/product?brand=' . $b->slug) }}">
                                        {{ $b->name }}
                                    </a>
                                </li>
                            @endforeach
                    ...
                    {{-- Color --}}
                    <div class="single__widget widget__bg">
                        <h2 class="widget__title h3">Colors</h2>
                        <ul class="widget__tagcloud">
                            @foreach ($color as $co)
                                <li class="widget__tagcloud--list">
                                ...
                                <div class="product__view--mode d-flex align-items-center">
                                    ...
                                    <div class="product__view--mode__list product__short--by align-items-center d-flex ">
                                        ...
                                        <div class="select shop__header--select">
                                            <select class="category product__view--select" name="category">
                                    ...
                                    <div class="product__view--mode__list product__short--by align-items-center d-flex">
                                        <div class="select shop__header--select">
                                            <select class="brand product__view--select" name="color">
                                                <option value="">Color</option>
                                                @foreach ($color as $co)
                                                    <option value="{{ $co->slug }}">{{ $co->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product__view--mode__list product__short--by align-items-center d-flex">
                                        ...
                                        <div class="select shop__header--select">
                                            <select class="brand product__view--select" name="brand">
                                    ...
                                    <input type="text" class="select shop__header--select" placeholder="enter search"
                                        name="search" id="" style="font-size: 15px">
                                    <input type="submit" class="btn btn-sm bg-primary text-white" value="search"
                                        id="" style="font-size: 12px">

                                    {{-- <a href="" class="btn btn-primary"> search</a> --}}
                                    <a href="{{ route('product') }}" class="btn btn-danger"> Clear</a>
                                </div>
                                                ...
                                                <article class="product__card">
                                                    ...
                                                    <div class="product__card--content text-center">
                                                        ...
                                                        <div class="product__card--price">
                                                            <span class="current__price">{{ $p->discount_price }}</span>
                                                            <span class="old__price"> {{ $p->sale_price }}</span>
                                                        </div>
                                                    </div>
                                                </article>
                                            </div>
            ...
            <div class="feature__inner d-flex justify-content-between">
                <div class="feature__items d-flex align-items-center">
                    <div class="feature__icon">
                        <img src="{{ asset('web_assets/assets/img/other/feature1.webp') }}" alt="img">
                    </div>
                ...
                <div class="feature__items d-flex align-items-center">
                    <div class="feature__icon ">
                        <img src="{{ asset('web_assets/assets/img/other/feature2.webp') }}" alt="img">
                    </div>
                    <div class="feature__content">
                ...
                <div class="feature__items d-flex align-items-center">
                    <div class="feature__icon">
                        <img src="{{ asset('web_assets/assets/img/other/feature3.webp') }}" alt="img">
                    </div>
                    <div class="feature__content">
                ...
                <div class="feature__items d-flex align-items-center">
                    <div class="feature__icon">
                        <img src="{{ asset('web_assets/assets/img/other/feature4.webp') }}" alt="img">
                    </div>
                    <div class="feature__content">
